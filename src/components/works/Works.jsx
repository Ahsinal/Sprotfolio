...
const Works = () => {
  ...
  return (
    <div className='works' id='works'>
      ...
      <ArrowBackIosIcon className='arrow left icons' alt="left arrow" onClick={()=>handleClick("left")}/>
      <ArrowForwardIosIcon className='arrow right icons' alt="right arrow" onClick={()=>handleClick("")}/>
    </div>
  )
}
